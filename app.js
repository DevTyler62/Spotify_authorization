...
app.get('/login', function(req, res) {
  ...
  var scope = 'user-read-private user-read-email user-read-playback-state playlist-read-private user-top-read user-modify-playback-state';
  ...
  if (state === null || state !== storedState) {
    ...
    request.post(authOptions, function(error, response, body) {
      if (!error && response.statusCode === 200) {
        ...
        // res.redirect('https://datafy-web-app.herokuapp.com/#' +
          querystring.stringify({
